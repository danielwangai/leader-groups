...
class BroadcastsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create broadcast" do
    assert_difference('Broadcast.count') do
      post broadcasts_url, params: { broadcast: { content: @broadcast.content, title: @broadcast.title } }
    end
  ...
  test "should update broadcast" do
    patch broadcast_url(@broadcast), params: { broadcast: { content: @broadcast.content, title: @broadcast.title } }
